...
declare class Archivist {
     ...
     * @memberOf Archivist
     */
    mgetValues(queries: mage.archivist.IArchivistQuery[], options: mage.archivist.IArchivistGetOptions, callback:  ArchivistMGetCallback<VaultValue>): void;
    mgetValues(queries: mage.archivist.IArchivistQuery[], callback: ArchivistMGetCallback<VaultValue>): void;
...
declare namespace mage {
    namespace archivist {
         ...
         * @extends {Function}
         */
        interface AclTest extends Function {
            (acl: string[], operation: VaultOperation | '*', options?: { shard: boolean }): void;
        }
         ...
         */
        type ArchivistTopicVaultConfiguration = {
            shard?: (value: VaultValue) => boolean,
            acl?: (test: AclTest) => void
        }
        ...
        interface ITopic {
            index: string[],
            vaults: {[name: string]: ArchivistTopicVaultConfiguration},
